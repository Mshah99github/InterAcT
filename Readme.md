...
1. **UT-Interaction Dataset**
   ...
   - **Reference:** Ryoo MS, Aggarwal JK. Spatio-temporal relationship match: Video structure comparison for recognition of complex human activities. 2009. Available from: [IEEE Xplore](https://ieeexplore.ieee.org/document/5459361)  
...
3. **Drone-Action Dataset**
   ...
   - **Reference:** Perera AG, Law YW, Chahl J. Drone-Action: An Outdoor Recorded Drone Video Dataset for Action Recognition. 2019. Available from: [MDPI](https://www.mdpi.com/2504-446X/3/4/82)  
